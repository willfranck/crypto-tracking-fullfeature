export default function DemoInfo() {
  return (
    <article className='flex flex-col md:flex-row justify-center items-center w-full pt-36 pb-14 text-gray-300 bg-gray-800'>
      <div className='p-8 space-y-2 md:text-right'>
        <p>This is my first project using NextJS, TypeScript, and Tailwind CSS</p>
        <p>I built this demo to showcase my ability to adapt and learn new frameworks & libraries</p>
