  ...
  return (
    <article className='flex flex-col justify-start items-center w-full lg:pl-10'>
      ...
      <div className='flex justify-center items-start w-full'>
        <div className='grid grid-cols-1 md:grid-cols-[minmax(256px,512px)_minmax(256px,512px)] gap-x-8 gap-y-4 w-full md:w-auto lg:max-h-cardGrid py-4 rounded-xl bg-tint overflow-y-auto'>
          {slicedCurrencies &&
